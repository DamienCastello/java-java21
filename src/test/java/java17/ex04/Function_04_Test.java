...
public class Function_04_Test {
    ...
    Predicate<Person> lastnameIsFrance =
            p -> p.getLastname().equals("France");


    // TODO compléter la fonction
    // TODO le prédicat vérifie que le prénom est "Armor"
    Predicate<Person> firstnameIsArmor =
            p -> p.getFirstname().equals("Armor");
    // end::predicateand[]
    ...
    public void test_predicate_and() throws Exception {
        ...
        List<Person> result = filter(
                personList,
                adult.and(lastnameIsFrance).and(firstnameIsArmor)
        );
